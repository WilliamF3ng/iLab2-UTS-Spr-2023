...
def main():
    ...
    if user_type == "Employee":
        ...
        if submitted:
            ...
            table_data = {"Day": [], "Hours Worked": [], "Evening Shift": [], "Rate Description": [], "Rate": [],
                          "Pay": []}
            ...
            for day, data in day_data.items():
                ...
                if day_data[day]["hours_worked"] >= 4:
            ...
            if days_with_more_4hs:
                    ...
                    f"Usually this break can be between 30 minutes to 1 hour depending on your shift and your employer.")
