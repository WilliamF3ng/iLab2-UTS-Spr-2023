...
def main():
    st.markdown("![Alt Text](https://media.giphy.com/media/eztQvSbWw6WWaLMapW/giphy.gif)") # LOL even supports GIFs
    st.title(':money_with_wings: Know your Wages User Login')

    #with st.form("user auth"):
    ...
    #password = st.text_input('Password', placeholder="Enter your password", type='password')
       ...
       # if username in user_credentials:
            #stored_hash = user_credentials[username]
                ...
                # Display your app content here after successful login
